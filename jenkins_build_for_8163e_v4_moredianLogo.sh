...
cp /share/samba/public/incomming/moredian.bmp ./bootable/bootloader/lk/dev/logo/wxga/wxga_kernel.bmp
cp /share/samba/public/incomming/moredian.bmp ./bootable/bootloader/lk/dev/logo/wxga/wxga_uboot.bmp 
