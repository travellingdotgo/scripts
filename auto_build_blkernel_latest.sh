...
#rm -rf vendor/htt/custom_apk/basecamp.apk # mv vendor/htt/custom_apk/basecamp.apk vendor/htt/custom_apk/basecamp.apk.bac
rm -rf vendor/htt/custom_apk/readme.txt   # mv vendor/htt/custom_apk/readme.txt vendor/htt/custom_apk/readme.txt.bac
#wget -P ./vendor/htt/custom_apk/ --no-passive-ftp --user=ftpuser --password='ftpuser' $FTP_FOLDER/$APK_NAME
cp /home/jenkins/resource/outdoor_latest.apk ./vendor/htt/custom_apk/Outdoor.apk
#wget -P ./vendor/htt/custom_apk/ --no-passive-ftp --user=ftpuser --password='ftpuser' ftp://193.168.2.23/release/basecamp/basecamp.apk
#wget -P ./vendor/htt/custom_apk/ --no-passive-ftp --user=ftpuser --password='ftpuser' $FTP_FOLDER/readme.txt
